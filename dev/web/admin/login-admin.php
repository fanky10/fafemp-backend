...
<head>
  ...
  <title>Foro Argentino de Facultades y Escuelas de Medicina Públicas | ADMIN SITE</title>
			...
			<ul class="nav link-list" align="center">
		  		<li class="usuario" align="center">
		     		<label for="usuario">Ingrese Usuario</label>
	 	     		<input id="usuario" class="twelve required" type="text" name="usuario">
		  		</li>
	       </ul>
			<ul class="nav link-list" align="center">
		   	<li class="password">
	            <label for="password">Ingrese Pasword</label>
		      	<input id="password" class="twelve required" type="password" name="password">
		   	</li>
		 	</ul>
		 	<ul class="nav link-list" align="center">
